...
public class RecordServlet extends HttpServlet {
    ...
    /**
     * /record.let?type=add&mid=xx&ids=xx
     * /record.let?type=queryback&idn=xxx --- 根据会员的身份证号查询会员信息及借阅信息
     * /record.let?type=back&mid=xxx&ids=xx  ---- 图书归还
     * /record.let?type=keep&id=xxx  ---- 书籍续借的功能
     * /record.let?type=doajax&typeId=xxx&keyword=xxx   ---- ajax查询
     * @param req
     * @param resp
