                                            ...
                                            <form action="book.let?type=modify" method="post" enctype="multipart/form-data">
                                                <table width="100%" class="cont">
                                                    <tr>
                                                        ...
                                                        <td rowspan="8" valign="top" >
                                                            <fieldset style="width: 210px; height: 370px;">
                                                             <legend>图片预览</legend>
                                                             <img id="imgPic" src="${book.pic}" width="250px" height="300px"/>
                                                            </fieldset>
                                                        </td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>图片：</td>
                                                        <!--
                                                            1.用户不需要修改图片（不选择图片），数据库应该保存之前的图片
                                                            2.用户需要修改图片，文件上传（保存文件）
                                                        -->
                                                        <!--保存之前的图片路径-->
                                                        <input type="hidden" name="pic"  value="${book.pic}">
                                                        <td width="20%"><input type="file" id="filePic" name="filePic"  value="${book.pic}"/>
                                                        </td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
